...
class For_investors extends MY_Controller {
	...
	public function accredited_investor_form($action = FALSE)
	{
		...
		if ('success' == $action)
		{
			$this->data['success'] = 'Thank you for submitting the Accredited Investor Suitability Form. We will be in contact with you shortly.</p><p>If you require immediate assistance, please contact Investor Services at <a href="tel:+12124986962">212.498.6962</a> or <a href="mailto:investorservices@nhcohenpartners.com">investorservices@nhcohenpartners.com</a>';
		}
